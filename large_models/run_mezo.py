...
class OurArguments(TrainingArguments):
    ...
    mezo_lora_normal: bool = (
        False  # restrict MeZO perturb/update scope to non-embedding 2D parameters
    )
    mezo_skip_1d: bool = (
        False  # skip 1D parameters while keeping other full-scope parameters
    )
    mezo_skip_position_embeddings: bool = (
        False  # skip position embedding matrices while keeping token embeddings
    )
